...
int main(int argc, char* argv[])
{
  ...
  // SCOPE: save number of PRBs
  cell_prbs_global = args.enb.n_prb;
  ...
  // SCOPE: save period at which metrics are recorded by srsLTE
  metrics_period_secs = args.general.metrics_period_secs;

  // SCOPE: initialize random number generator
  srand(time(NULL));
