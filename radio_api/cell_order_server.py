...
class CellOrderServerProtocol(asyncio.Protocol):
    ...
    def __init__(self, loop, config):
        ...
        self.lat_budget_offset_ms = 38 # TODO: Dynamically determine this
    ...
    def reallocate_resources(self):
        ...
        for s_key, s_val in slice_metrics.items():
            ...
            # slice_metrics[s_key]['new_num_rbgs'] = min(slice_metrics[s_key]['new_num_rbgs'], int(constants.MAX_RBG / 2))
